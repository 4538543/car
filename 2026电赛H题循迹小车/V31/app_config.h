...
#define PA18_FORCE_STOP_DISTANCE_MM          (5810U)
...
#define PB22_RAMP_UP_STEP_PER_10MS             (1)
#define PB22_RAMP_UP_INTERVAL_10MS_TICKS       (2U)
#define PB23_RAMP_UP_STEP_PER_10MS             (1)
#define PB23_RAMP_UP_INTERVAL_10MS_TICKS       (3U)
#define PB22_PB23_RAMP_DOWN_STEP_PER_10MS      (1)
#define PB22_PB23_RAMP_DOWN_INTERVAL_10MS_TICKS (3U)

/*
 * PB22 reaches full speed near the first-curve entry; PB23 uses a longer
 * envelope and reaches full speed near the middle of that curve. The 140
 * permille floor prevents a distance/PWM deadlock before the wheels begin
 * producing encoder edges. Above the floor, both the time ramp and the
 * selected mode's distance envelope must permit the requested speed.
 */
#define PB22_PB23_STARTUP_MIN_PWM_PERMILLE   (140)
#define PB22_FULL_SPEED_DISTANCE_MM          (1400U)
#define PB23_FULL_SPEED_DISTANCE_MM          (2300U)
...
#define PB22_PB23_SEGMENT_RAMP_DOWN_STEP_PER_10MS (1)
#define PB22_PB23_SEGMENT_RAMP_INTERVAL_10MS_TICKS (3U)
