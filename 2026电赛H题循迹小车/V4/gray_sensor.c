...
void GraySensor_sample(void)
{
     ...
     * transverse finish marker covers about three to five adjacent probes.
     * The car can still be offset while leaving the final curve, so the group
     * need not include the two center probes. Rejecting seven/eight probes
     * avoids a stuck-low DAT false trigger.
     */
