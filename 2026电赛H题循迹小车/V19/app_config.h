 ...
 */
#define PA18_LAP_CRUISE_PWM_PERMILLE       (286) /* V8 220 * 130% */
#define PA18_LAP_APPROACH_PWM_PERMILLE     (221) /* V8 170 * 130% */
#define PB22_AB_CRUISE_PWM_PERMILLE        (330) /* V8 300 * 110% */
#define PB22_AB_APPROACH_PWM_PERMILLE      (198) /* V8 180 * 110% */
#define PB23_LAP_CRUISE_PWM_PERMILLE       (242) /* V8 220 * 110% */
#define PB23_LAP_APPROACH_PWM_PERMILLE     (187) /* V8 170 * 110% */
#define PB22_PB23_PASS_PWM_PERMILLE        (176) /* V8 160 * 110% */

#define PA18_LINE_GAIN_PERCENT             (130)
#define PB22_PB23_LINE_GAIN_PERCENT        (110)
#define PA18_RAMP_UP_STEP_PER_10MS            (5)
#define PA18_RAMP_DOWN_STEP_PER_10MS          (8)
#define PB22_PB23_RAMP_UP_STEP_PER_10MS       (3)
#define PB22_PB23_RAMP_DOWN_STEP_PER_10MS     (4)
