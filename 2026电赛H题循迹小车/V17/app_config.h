...
/*
 * PA18 lap stop uses only the requested three conditions: encoder distance,
 * grayscale active count and integrated gyro angle. PB23 still uses the
 * qualified finish marker and then continues for body clearance.
 */
