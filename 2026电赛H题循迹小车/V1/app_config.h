 ...
 * Average left/right encoder distance follows the track centerline even in
 * the two semicircles. These initial values need real-vehicle calibration.
 */
#define LAP_SLOW_DOWN_COUNT             (41347U)  /* about 5800 mm */
#define LAP_BRAKE_START_COUNT           (43129U)  /* about 6050 mm */
#define LAP_TARGET_COUNT                (43785U)  /* about 6142 mm */
