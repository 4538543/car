...
#define PB23_FINISH_WINDOW_COUNT          (42780U) /* about 6000 mm */
#define PB23_FINISH_MIN_TURN_CENTIDEG     (34000)  /* final-curve exit */
...
#define PA18_LINE_GAIN_PERCENT             (169) /* V8 gain * 130% * 130% */
...
#define PB22_PB23_RAMP_UP_STEP_PER_10MS       (2)
#define PB22_PB23_RAMP_DOWN_STEP_PER_10MS     (3)
...
#define LINE_CURVE_ENTER_CONFIRM_10MS_TICKS   (3U)
