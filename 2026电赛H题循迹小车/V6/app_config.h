...
#define GRAY_FINISH_MIN_CONSECUTIVE_SENSORS    (3U)
...
#define LAP_FINISH_ARM_RELATIVE_COUNT    (38491U)  /* 5400 mm after start line */
#define LAP_MISSED_MARKER_RELATIVE_COUNT (45068U)  /* 6322 mm after start line */
#define LAP_FINISH_CONFIRM_10MS_TICKS       (2U)
#define MARKER_NORMAL_LINE_RECENT_10MS_TICKS (20U)
...
#define PASS_AFTER_POINT_PWM_PERMILLE      (160)
