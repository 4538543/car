...
void GraySensor_sample(void)
{
     ...
     * probes. The mission layer requires a recent normal 1/2-probe line
     * before accepting the wide pattern, so a continuously stuck-low DAT
     * signal is not accepted as a completion marker.
     */
