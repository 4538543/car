...
/* Each task owns all six PID gains. Values are multiplied by 1000. */
#define APP_TASK1_OUTER_KP_MILLI_PER_S         1500L
#define APP_TASK1_OUTER_KI_MILLI_PER_S2        50L
#define APP_TASK1_OUTER_KD_MILLI               100L
#define APP_TASK1_INNER_KP_MILLI_STEP_PER_CMPS 6600L
#define APP_TASK1_INNER_KI_MILLI_STEP_PER_CM   1200L
#define APP_TASK1_INNER_KD_MILLI_STEP_PER_CMPS2 20L

#define APP_TASK2_OUTER_KP_MILLI_PER_S         1500L
#define APP_TASK2_OUTER_KI_MILLI_PER_S2        50L
#define APP_TASK2_OUTER_KD_MILLI               100L
#define APP_TASK2_INNER_KP_MILLI_STEP_PER_CMPS 6000L
#define APP_TASK2_INNER_KI_MILLI_STEP_PER_CM   1200L
#define APP_TASK2_INNER_KD_MILLI_STEP_PER_CMPS2 20L

#define APP_TASK3_OUTER_KP_MILLI_PER_S         1500L
#define APP_TASK3_OUTER_KI_MILLI_PER_S2        70L
#define APP_TASK3_OUTER_KD_MILLI               100L
#define APP_TASK3_INNER_KP_MILLI_STEP_PER_CMPS 6000L
#define APP_TASK3_INNER_KI_MILLI_STEP_PER_CM   1200L
#define APP_TASK3_INNER_KD_MILLI_STEP_PER_CMPS2 20L
